...
CREATE TABLE IF NOT EXISTS ChapterMedia (
  ...
  chmSubType enum('spoken-male','spoken-female','music-vocal','music-accompaniment','360p','720p','1080p','hls','youtube') DEFAULT NULL,
  chmUrl varchar(250) DEFAULT NULL,
  chmImageUrl varchar(250) DEFAULT NULL,
  ...
  chmChurchImageAssetId varchar(100) DEFAULT NULL,
  PRIMARY KEY (id),
  KEY IDX_Chapter_pubKey_chSlug (pubKey, chSlug),
